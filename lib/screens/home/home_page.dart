...
import 'package:setup_mvvm/screens/home/home_app_bar.dart';
import 'package:setup_mvvm/screens/home/home_drawer.dart';
import 'package:setup_mvvm/screens/home/home_float.dart';
import 'package:setup_mvvm/screens/schedule/schedule_screen.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _openScheduleScreen(BuildContext context) async {
    final result = await Navigator.push(context, ScheduleScreen.route());
    if (result != null) {}
  }
                ...
                children: <Widget>[
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "Features", style: TextStyle(fontSize: 30,  ) ,
                      ),
                    ),
                  ),
                ],
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                  primary: Color(item["color"]).withAlpha(150),
